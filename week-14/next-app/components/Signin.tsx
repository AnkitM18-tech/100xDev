 // describe as client side component. every component in nextjs is by default a server side component. defer the client as much as possible in order to use server side , seo optimizations.
